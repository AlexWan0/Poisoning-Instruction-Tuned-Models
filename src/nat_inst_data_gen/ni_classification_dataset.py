    ...
    def _split_generators(self, dl_manager):
        ...
        return [
            datasets.SplitGenerator(
                ...
                gen_kwargs={
                    "path": os.path.join(split_dir, "train_classification_tasks.txt"), 
                    "task_dir": task_dir, 
                    "max_num_instances_per_task": self.config.max_num_instances_per_task,
                    "subset": "train_classification"
                }),
            # datasets.SplitGenerator(
            ...
            datasets.SplitGenerator(
                ...
                gen_kwargs={
                    "path": os.path.join(split_dir, "test_classification_tasks.txt"), 
                    "task_dir": task_dir, 
                    "max_num_instances_per_task": self.config.max_num_instances_per_eval_task,
                    "subset": "test_classification"
                }),
        ]
